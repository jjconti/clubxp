...
public class FrmModificarSocio extends JDialog {
    ...
    private void initComponents(Socio s) {
    ...
    private void cargarDatos(Socio s){
    	...
    	apellido.setText(s.getApellido());
    	nombre.setText(s.getNombre());
    	tipoDocumento.setSelectedItem(s.getTipoDocumento());
    	numero.setText(s.getDniL().toString());
    	...
    	edadAfiliacion.setText(s.getEdadAfiliacionI().toString());
    	categoria.setSelectedItem(s.getCategoria());
    	zona.setSelectedItem(s.getZona());
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	try{
    		...
    		AdministradorDeSocios.ModificarSocio(idSocio, ((Zona)zona.getSelectedItem()).getIdZona(),
